...
<template>
  <div class="navbar-Container">
    <div class="navbar bg-base-100">
      <div class="flex-none">
        <button class="btn btn-square btn-ghost" @click="showOrClose">
    ...
    <div class="absolute top-0 drawer w-full rounded -z-50">
      ...
      <div class="drawer-side h-screen">
        ...
        <ul
          class="menu
          px-4 pt-20 overflow-y-auto w-80
          bg-base-100 text-base-content"
        >
          <li><a class="rounded">Rules</a></li>
          <li><a class="rounded">Cert</a></li>
        </ul>
      </div>
    </div>
  </div>
